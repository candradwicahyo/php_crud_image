...
if (isset($_POST['submit'])) {
  if (ubah($_POST, $id, $row['email'], $row['gambar']) > 0) {
          ...
          <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
              <div class="text-center mb-3">
                <img src="assets/image/<?= $row['gambar']; ?>" class="rounded" width="300">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" name="umur" class="form-control" id="umur" placeholder="umur" autocomplete="off" value="<?= $row['umur']; ?>">
                <div class="invalid-feedback">
                  <small class="text-danger">...</small>
                </div>
              </div>
